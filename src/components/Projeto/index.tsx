...
const Projeto = () => (
  <Card>
    ...
    <ContainerDetails>
      ...
      <Texto tipo="secundario" inBox={true}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam sed vero ipsum quam dolorum culpa reprehenderit fugiat non laborum.</Texto>
    </ContainerDetails>
